...
<head>
    ...
    <style>
        * {
        ...
        .edit-room-btn:hover { background: #45a049; transform: scale(1.05); }
        ...
        @media (max-width: 992px) {
            .room-section { max-width: 95%; padding: 15px; }
...
<body>
    ...
    <div class="content" id="content">
                    ...
                    <tbody>
                        @forelse($rooms as $room)
                            ...
                            <tr class="{{ $rowClass }}">
                                ...
                                <td>
                                    @php
                                        $students = $room->bookings()->where('status', 'approved')->with('user')->get();
                                    @endphp
                                    @if($students->count() > 0)
        ...
        // --- 3. File Input Logic (Fixed "Double Browse") ---
        // Only target the specific Browse button and Image input by ID
        const browseBtn = document.getElementById('browseButton');
        const roomImageInput = document.getElementById('roomImage');
        const fileNameSpan = document.getElementById('fileName');

        if(browseBtn && roomImageInput) {
        ...
        function openEditModal(room) {
            ...
            // Fill Select Options Logic (Rebuilding options to select correct one)
